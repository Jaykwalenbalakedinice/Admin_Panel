              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <img
                      class="direct-chat-img"
                      src="AdminLTE-3.2.0/dist/img/user3-128x128.jpg"
                      alt="message user image"
                    />
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                  ...
                  <ul class="contacts-list">
                    ...
                    <li>
                      <a href="#">
                        <img
                          class="contacts-list-img"
                          src="AdminLTE-3.2.0/dist/img/user7-128x128.jpg"
                          alt="User Avatar"
                        />
                    ...
                    <li>
                      <a href="#">
                        <img
                          class="contacts-list-img"
                          src="AdminLTE-3.2.0/dist/img/user5-128x128.jpg"
                          alt="User Avatar"
                        />
                    ...
                    <li>
                      <a href="#">
                        <img
                          class="contacts-list-img"
                          src="AdminLTE-3.2.0/dist/img/user6-128x128.jpg"
                          alt="User Avatar"
                        />
